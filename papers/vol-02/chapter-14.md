...
5. **バックエンド差テスト**：同じ seed / 同じモデルを pytensor と numpyro で走らせ、事後平均を **Ch12 §12.7 の sd 正規化 tolerance** に収めるか確認
...
<a id="ref-14-6">[14-6]</a> Wasserstein, R. L., & Lazar, N. A. (2016). The ASA's Statement on p-Values: Context, Process, and Purpose. *The American Statistician*, 70(2), 129–133. — p 値の運用注意（§14.3）の公式声明
