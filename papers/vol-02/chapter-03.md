...
flowchart TD
    ...
    P1 --> Cap
    Cap --> Result["第13章 capstone<br/>（第13章）"]
```
...
## 3.8 第4章への橋渡し（章末チェックリスト）

以下がすべて「はい」であれば、第4章に進めます。
...
- AI エージェント × Jupyter MCP の作業ループは vol-01 と同じだが、**CV・診断・provenance の 4 規律**が第4章以降で加わる
